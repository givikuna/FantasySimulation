...
describe("fib", () => {
    ...
    it("should return 1 for Fibonacci of 0 and 1", () => {
        const n: number = 0;
        const expected: number = 1;
        const result: number = fib(n);
        expect(result).to.equal(expected);
...
describe("square", () => {
    ...
    it("should return 0 for square of 0", () => {
        const n: number = 0;
        const expected: number = 0;
        const result: number = square(n);
        expect(result).to.equal(expected);
...
describe("sieveOfEratosthenes", () => {
    it("should return prime numbers up to n", () => {
        const n: number = 10;
    ...
    it("should return empty array for n < 2", () => {
        const n: number = 1;
        const expected: number[] = [];
        const result: number[] = sieveOfEratosthenes(n);
        expect(result).to.deep.equal(expected);
...
describe("neg", () => {
    it("should return negative for positive numbers", () => {
        const n: number = 5;
    ...
    it("should return positive for negative numbers", () => {
        const n: number = -5;
        const result: number = neg(n);
        expect(result).to.equal(-5);
    });
